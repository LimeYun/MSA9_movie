...
## 🎥 **프로젝트 발표 영상**  
[**발표 영상 링크**](https://youtu.be/tROcWjKgmTU?si=jT7TXKWd8OXaBon- target="_blank")
...
## 이세진
- **한계점**: 이번 프로젝트를 하며 느낀 한계점으로는 인공지능을 활용하여 구성한 점이 다수 존재함에 있어서 AI에 대한 의존도를 조절해야겠다고 느꼈고.
- **보완점**: 반복 학습과 다양한 경험으로 코드의 이해력과 응용력을 높임으로써 보완해야겠다고 생각했습니다.
- **소감**: 이번 프로젝트를 하면서 팀 단합력이 높아 서로를 존중하며 거리낌없이 다양한 의견을 제시하고 조율하는 과정이 매우 순조로웠다고 생각합니다. 그리고 문제점에 있어 적극적으로 서로에게 물어보고 해결하려는 열정에 있어 높은 점수를 주고 싶습니다. 또한 AI가 제공하는 코드를 이해하며 잘못된 정보와 좋은 정보를 구별하여 적용하고 다양한 코드를 접하면서 지식이 향상함을 느꼈고, 학습과 실습을 거치며 나만의 코드를 만들어가는 과정이 매우 뿌듯하고 의미가 있었습니다.
...
- **소감**: 이번 프로젝트를 통해 예상보다 자바스크립트를 많이 사용하면서 배웠던 것들을 복습하거나, 새로운 지식을 배울 수 있었습니다. 그리고, FullCalendar API를 처음 사용하면서 외부 API 사용에 대한 두려움이 있었지만, API 문서를 꼼꼼히 읽고 인터넷 검색을 통해 사용해 보니 예상보다 어렵지 않다는 것을 느꼈습니다. 또, 설계 단계부터 팀원들과 활발히 의견을 나누고 모르는 것은 서로 물어보다 보니 큰 어려움 없이 프로젝트를 완료할 수 있었던 것 같습니다. 감사합니다.


## 홍성윤
- **한계점**: 저는 개발 단계에 있을 때 스스로 설계에 대한 더 확실한 이해가 필요하다는 점을 느꼈습니다. 
...
- **보완점**: 추후에는 주석과 문서화를 보다 적극적으로 활용하여 협업의 효율성을 높이고, 진행 중간중간마다 전체 흐름을 점검하여 더 효율적이고 완성도 높은 프로젝트를 만들어 갈 생각입니다.
- **소감**: 저희 팀은 구성원들이 각자의 의견을 자유롭게 제시하고 조율했으며, 서로의 부족한 부분을 함께 도와 프로젝트를 완성했기에 좋은 시너지를 낼 수 있었습니다. 그 과정에서 협업의 중요성과 제 역량의 부족함을 깊이 깨달았으며, 더욱 전문성을 갖춘 개발자가 되기 위해 끊임없이 정진할 것을 다짐했습니다. 감사합니다.
